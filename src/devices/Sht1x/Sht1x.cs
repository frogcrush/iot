...
namespace Iot.Device.Sht1x
{
    ...
    public class Sht1x : IDisposable
    {
        ...
        private void ReadTemperature()
        {
            ...
            _temperature = Temperature.FromDegreesCelsius((rawValue * (_resolution == Resolution.High ? 0.01 : 0.04)) + _temperatureConversionTable[_supplyVoltage]);
        }
        ...
        private void ReadHumidity()
        {
            ...
            _humidity = Math.Round(((_temperature.DegreesCelsius - 25) * (0.01 + ((_resolution == Resolution.High ? 0.00008 : 0.00128) * rawValue))) + linearHumidity, 2);
        }
